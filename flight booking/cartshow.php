...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <form  method="post" action="couponform.php">
      <div class="form-group">
                            <label for="">Apply coupoun</label>
                            <input type="coupon" name="coupon" placeholder="coupon">
                            <button onchange='this.form.submit()' name="submi">Submit</button>
                        </div>
        </form><br><br>
      <?php
...
if (!isset($_SESSION['user'])) {
    ...
    if ($rowcount == 0) {
        echo "<div class='alert alert-info'><strong>Nothing in the Bookings.</strong></div>";
    } else {
        ...
        echo " <form action='../ticket reservation/reserved.php' method='post'>";
        echo "<div class='row'>
                  <div class='col-sm-4'></div>
                  <div class='col-sm-4'><p class='lead'>Total: <span id='total'>₹" . $gt . "</span></p></div>
