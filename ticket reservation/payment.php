...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="../flight booking/homepage.html"><span class="glyphicon glyphicon-backward"></span> Back To Home</a></li>
    </ul>
  </div>
</nav>
	...
	<div class="col-md-6">
		<div class="panel panel-default">
			<div class="panel-body">
			 ...
			 <div class="panel panel-success">
			 	<div class="panel-heading">
			 		<h3 class="panel-title"><center>FLIGHT TIMINGS</center></h3>
			 	</div>
			 	<div class="panel-body">
			 		<strong>
			 			<i>Airship</i>
			 ...
			 <div class="panel panel-success">
				...
				PASSENGERS</strong>
					<table id="myTable-party" class="table table-bordered table-hover" cellspacing="0" width="100%">
						   ...
						   <center>
							   <a href="../flight booking/homepage.html" class="btn btn-success">Return Home
