	...
	<div class="col-md-10">
		<div class="panel panel-danger">
			<div class="panel-heading">
				<h3 class="panel-title">STEPS FOR BOOKING<span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span></h3>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="panel panel-info">
							<div class="panel-heading">
								<h3 class="panel-title">2. CLASS</h3>
							</div>
							<div class="panel-body">
								CLASS TYPE
							</div>
				...
				<div class="container-fluid">
					<form class="form-horizontal" role="form" id="form-itinerary">
					  ...
					  <div class="form-group">
					    ...
					    <input type="date"  min="2023-05-22" class="btn btn-default" id="dept-date">
