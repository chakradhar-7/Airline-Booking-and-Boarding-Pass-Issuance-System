...
if(isset($_POST['bookBy'])){
	...
	$sql = "INSERT INTO booked (book_by, book_contact, book_address, book_name, book_age, book_gender,
			 book_departure, dest_id, acc_id, origin_id, book_tracker, seat_number)
			 VALUES(?,?,?,?,?,?,?,?,?,?,?,?);
	";

$result = $db->insertRow($sql, [$bookBy, $cont, $address, $fN, $age, $gender, $deptDate, $dest, $acc, $origin, $tracker, $seat]);
